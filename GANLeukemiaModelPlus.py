...
class GANLeukemiaModelPlus:
    ...
    def plot_damage_curve(self, time, damage_level, output_image):
...
# 创建 GANLeukemiaModelPlus 实例
gan_leukemia_model = GANLeukemiaModelPlus(num_features, num_samples, noise_dim)
...
gan_leukemia_model.plot_damage_curve(time, damage_level, 'leukemia_damage_curve.png')
